package file_read_write_xml.sax_parser;
...
public class ReadXMLFileUsingSaxparser extends DefaultHandler {
	...
	public void characters(char[] buffer, int start, int length) {
		...
		System.out.println("In Characters " + start + " " + length);
	...
	public void startElement(String uri, String localName, String qName,
		...
		System.out.println("startElements " + qName);
		temp = "";
	...
	public void endElement(String uri, String localName, String qName)
			throws SAXException {
		System.out.println("endElements " + qName);
